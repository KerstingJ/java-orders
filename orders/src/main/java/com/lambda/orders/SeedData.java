...
{
    private CustomerDao custrepos;
    private AgentDao agentrepos;
    private OrderDao ordersrepos;

    public SeedData(CustomerDao custrepos, AgentDao agentrepos, OrderDao ordersrepos)
    {
